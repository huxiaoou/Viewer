...
argument_parser.add_argument("--config", type=str, help="config file path")
args = argument_parser.parse_args()

instru_info_tab = CInstrumentInfoTable(args.info, file_type="CSV")

mgr_viewer = CManagerViewer(position_file_path=args.src, config_path=args.config, instru_info_tab=instru_info_tab)
